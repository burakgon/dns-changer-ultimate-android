...
class TaskerIntentReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        when (intent.action) {
            ...
            ACTION_SWITCH -> handleSwitch(context, intent)
            ACTION_QUERY_STATUS -> handleQueryStatus(context)
    ...
    private fun handleSwitch(context: Context, intent: Intent) {
        scope.launch {
            try {
    ...
    private fun handleQueryStatus(context: Context) {
        scope.launch {
            try {
